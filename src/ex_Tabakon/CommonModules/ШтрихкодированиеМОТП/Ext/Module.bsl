...
Процедура ТБКЗаполнитьВложенныеШтрихкодыПолученныеИзСервиса(ВложенныеШтрихкоды, ТаблицаEAN, ПараметрыСканирования)
	// Вставить содержимое метода.
	//предидущаяХарактеристика = неопределено;
	//предидущаяМрц = неопределено;
	//Для Каждого стр0 из ВложенныеШтрихкоды.ДеревоУпаковок.Строки Цикл
	//	
	//	мрц = Справочники.ШтрихкодыУпаковокТоваров.ПолучитьМРЦ(стр0.Штрихкод);
	//	Если ЗначениеЗаполнено(мрц) Тогда
	//	Иначе
	//		мрц = предидущаяМрц;
	//	КонецЕсли;
	...
	//		мрц = Справочники.ШтрихкодыУпаковокТоваров.ПолучитьМРЦ(стр1.Штрихкод);
	//		мрц = ?(ЗначениеЗаполнено(мрц),мрц,предидущаяМрц);
	//		Если ЗначениеЗаполнено(мрц) Тогда
	//			стр1.Характеристика = Справочники.ШтрихкодыУпаковокТоваров.ПолучитьХарактеристику(
	//			стр1.Номенклатура,
	//			мрц
	//			);
	//			
	//		Иначе
	//			стр1.Характеристика = предидущаяХарактеристика;
	//		КонецЕсли;
	//		предидущаяХарактеристика = стр1.Характеристика;
	//	КонецЦикла;
	//КонецЦикла;

...
Процедура ТБКПроверитьАкцизныеМаркиПередЗаписьюЧека(СтруктураДляПроверки)
	...
	//|			И ЧекККМАкцизныеМарки.Ссылка.Организация = ТаблицаОрганизацииИМарки.Организация
	|ГДЕ
	...
	//|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ВозвратТоваровОтПокупателя КАК ВозвратТоваровОтПокупателя
	//|		ПО ВозвратТоваровОтПокупателяШтрихкодыУпаковок.Ссылка = ВозвратТоваровОтПокупателя.Ссылка
	//|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ТаблицаОрганизацииИМарки КАК ТаблицаОрганизацииИМарки
	//|		ПО ВозвратТоваровОтПокупателяШтрихкодыУпаковок.ШтрихкодУпаковки = ТаблицаОрганизацииИМарки.АкцизнаяМарка
	////|			И (ВозвратТоваровОтПокупателя.Организация = ТаблицаОрганизацииИМарки.Организация)
	//|ГДЕ
	//|	ВозвратТоваровОтПокупателя.Проведен
	//| 

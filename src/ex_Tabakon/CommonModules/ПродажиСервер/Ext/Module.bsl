...
Функция ТБКРаспределитьШтрихкодыПоТаблицеТоваров(ДокументОбъект, МассивУпаковок, Товары)
	...
	Для Каждого СтрокаТовары Из Товары Цикл
		...
		Для Каждого СтрокаРаспределения Из РаспределениеПоСтроке Цикл
			...
			//Марк 2025-02-25
			//деление на 0 СтрокаТоварыРазобранные.Количество
			Если СтрокаТоварыРазобранные.Количество = 0 Тогда  
				СтрокаТоварыРазобранные.Цена = Окр((СтрокаТоварыРазобранные.Сумма - СтрокаТоварыРазобранные.СуммаСкидок) / СтрокаТоварыРазобранные.КоличествоУпаковок, 2);	
			Иначе

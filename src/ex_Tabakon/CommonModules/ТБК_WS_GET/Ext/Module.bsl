...
Функция GetToken(вхПараметры) Экспорт 
	...
	Если Выборка.Следующий() Тогда
		...
		СоответствиеТокенов = Выборка.Данные.Получить();
		Для каждого КлючЗначение Из СоответствиеТокенов Цикл
			
			Если НЕ СтрНайти(Строка(КлючЗначение.Ключ), "<Объект не найден>") Тогда
				
				Возврат  КлючЗначение.Значение.КлючСессии;	

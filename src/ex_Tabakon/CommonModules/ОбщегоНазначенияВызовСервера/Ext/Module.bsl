...
Процедура ЗаполнитьВидПродукцииГИСМТ(Номенклатура) Экспорт
	//Марк 2026-07-17
	...
	Запрос.УстановитьПараметр("ВидПродукцииГИСМТ", Справочники.ВидыПродукцииИС.НайтиПоНаименованию("Табачная продукция", Истина));
	...
	Если Выборка.Следующий() Тогда
		...
		Попытка
			...
			// Здесь можно добавить запись в журнал регистрации для аудита
		Исключение

...
Функция ПолучитьСистемуНалогообложенияСрезПоследнихПоПервойОгранизации() Экспорт
	...
	Если ВыборкаСистемНалогообложения.Следующий() Тогда 
		...
		Если ВыборкаСистемНалогообложения.СистемаНалогообложения = Перечисления.ТипыСистемНалогообложенияККТ.УСНДоход  
			или ВыборкаСистемНалогообложения.СистемаНалогообложения = Перечисления.ТипыСистемНалогообложенияККТ.УСНДоходРасход 
			или ВыборкаСистемНалогообложения.СистемаНалогообложения = Перечисления.ТипыСистемНалогообложенияККТ.УСНДоходРасход5
			или ВыборкаСистемНалогообложения.СистемаНалогообложения = Перечисления.ТипыСистемНалогообложенияККТ.УСНДоходРасход7 Тогда

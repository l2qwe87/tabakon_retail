...
Процедура ТБКЗаполнитьДанныеПоШтрихкодамEAN(ДанныеПоШтрихкодамEAN)
	...
	|	LEFT JOIN Справочник.ХарактеристикиНоменклатуры Характеристики ПО Характеристики.Владелец = ШтрихкодыНоменклатуры.Владелец 
	|ГДЕ
	...
	Для Каждого ДанныеПоШтрихкоду Из ДанныеПоШтрихкодам Цикл 
		...
		Если ДанныеПоШтрихкоду.Номенклатура.ВидНоменклатуры.ИспользованиеХарактеристик = Перечисления.ВариантыВеденияДополнительныхДанныхПоНоменклатуре.НеИспользовать Тогда
			Прервать;
		КонецЕсли;
	КонецЦикла;

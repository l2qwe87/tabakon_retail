...
Процедура ТБКОбработатьДанныеШтрихкодаПотребительскойУпаковки(ДанныеШтрихкодаДляОбработки, ПараметрыШтрихкодаДляОбработки, Форма)
	...
	Если ШтрихкодированиеИСРТ.ЭтоМарка(ДанныеШтрихкодаДляОбработки.Штрихкод) Тогда
		...
		//Вик 2026-08-14    
		Попытка
			//НоваяСтрокаУпаковки.ТБКОтсканированнаяМарка	=	ПараметрыШтрихкодаДляОбработки.РезультатОбработки.ДанныеШтрихкода.НормализованныйШтрихкод;
			НоваяСтрокаУпаковки.ТБКОтсканированнаяМарка		=	Форма.ТБКОтсканированнаяМарка
		Исключение
		КонецПопытки;
		//КонецВик

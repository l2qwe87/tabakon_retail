...
Функция ПолучитьСкладИзООРП() ЭКСПОРТ
	...
	иначе
		...
		Запрос = Новый запрос("ВЫБРАТЬ
		                      ...
		                      |	И СТРЗАМЕНИТЬ(Склады.Наименование, "" "", """") <> """"");
...
Функция ПолучитьСтруктуруПодключенияFTP() экспорт
	...
	Запрос	=	Новый запрос("ВЫБРАТЬ
	      	 	             |	УдалитьНастройкиТранспортаОбменаДанными.Корреспондент КАК Корреспондент,
	      	 	             |	УдалитьНастройкиТранспортаОбменаДанными.FTPСоединениеПуть КАК FTPСоединениеПуть,
	      	 	             |	УдалитьНастройкиТранспортаОбменаДанными.FTPСоединениеПользователь КАК FTPСоединениеПользователь,
	      	 	             |	УдалитьНастройкиТранспортаОбменаДанными.FTPСоединениеПорт КАК FTPСоединениеПорт
	      	 	             |ИЗ
	      	 	             |	РегистрСведений.УдалитьНастройкиТранспортаОбменаДанными КАК УдалитьНастройкиТранспортаОбменаДанными");
...
//из передставления битой ссылки можно узнать ее гуид (РасшифровкаПредставленияБитойСсылки)
#Область Процидурки_С_Битой_Ссылкой

Функция РасшифровкаПредставленияБитойСсылки(ПредставлениеБитойСсылки, мСоответствиеИдентификаторовТипов = Неопределено) Экспорт
...
Функция ПолучитьСлучайноеЧисло(Мин,Макс) Экспорт
...
Функция ПоискПоГуиду(ГУИД) Экспорт
...
Процедура ЗаполнитьЗапросДанныхДляНовойУт(Товары) Экспорт

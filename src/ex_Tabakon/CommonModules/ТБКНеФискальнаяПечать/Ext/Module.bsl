...
Процедура ПечатьСтроки(ДрайверККМ,Стр , Выравнивание = 1, Отложенаня = Ложь)экспорт
...
Процедура ПечатьСтроки_Пробелы(ДрайверККМ, ТоЧтоСлева, ТоЧтоСправа, НуженЖир = Ложь, ШиринаЛенты)экспорт

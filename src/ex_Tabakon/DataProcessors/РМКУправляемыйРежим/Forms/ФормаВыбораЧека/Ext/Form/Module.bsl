...
Процедура ТБКИнструкцияПосле(Команда)  
	ОбщегоНазначенияВызовСервера.ОткрытьНужнуюИнструкцию("(отмена+чека)+день+в+день");		
КонецПроцедуры

&НаКлиенте
Процедура ТБКИнструкцияПробитьНепробитыйПосле(Команда)
	ОбщегоНазначенияВызовСервера.ОткрытьНужнуюИнструкцию("Не+вышел+кассовый+чек");		
КонецПроцедуры

...
Процедура ТБКПриОткрытииПосле(Отказ)
	...
	ПодключитьОбработчикОжидания("ОбновитьСтатусИнтернета",10);
		...
		Если (Событие = "Штрихкод" Или Событие = "ПолученШтрихкод") Тогда 
			...
			Если СтрДлина(Данные) > 21 Тогда 
				...
				Если Найти(Данные,"4660313541520") или Найти(Данные,"4627175411217") или Найти(Данные,"4627175411200") или Найти(Данные,"4627172718210") 
					...
					или Найти(Данные,"6973761110032") или Найти(Данные,"2001199790374") или Найти(Данные,"04627192382095")
			...
			//Марк 2025-01-16 перенес на верх
			//Данные	=	СтрЗаменить(Данные,Символ(29),"");   
			//Данные	=	СтрЗаменить(Данные,Символ(21),"");  
			//КонецМарк
...
Процедура ТБКОплатитьТоварыПослеВыбораККМПродолжение(Знач Результат, Знач ДополнительныеПараметры)
		Если Результат = Неопределено Тогда

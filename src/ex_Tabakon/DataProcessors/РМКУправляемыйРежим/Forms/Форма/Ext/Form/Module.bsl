	...
	Попытка
		Если НовыйДокументЧек.ПроверитьЗаполнение()  Тогда
			...
			Для каждого Строка Из НовыйДокументЧек.АкцизныеМарки Цикл
				...
				Если ЗначениеЗаполнено(НовыйДокументЧек.Ссылка) И ЗначениеЗаполнено(Строка.ШтрихкодУпаковки.Номенклатура) И ЗначениеЗаполнено(Строка.АкцизнаяМарка) Тогда

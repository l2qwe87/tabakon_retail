...
Процедура ТБКВнешнееСобытиеВместо(Источник, Событие, Данные)
	Если ВводДоступен() Тогда
		...
		Если (Событие = "Штрихкод" Или Событие = "ПолученШтрихкод") Тогда
			...
			//Вик 2024-04-15
			МаркаСписана	=	ПроверитьСписаниеМарки(СтрЗаменить(Данные,Символ(21),""));
			...
			Если ПроверитьЧтоЭтоВода(СтрЗаменить(Данные,Символ(21),"")) и СтрДлина(данные) > 13 и СтрДлина(данные) < 37 и ТекущаяДата()>'20230627' тогда

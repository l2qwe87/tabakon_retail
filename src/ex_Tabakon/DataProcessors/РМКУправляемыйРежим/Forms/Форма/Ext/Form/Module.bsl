...
&НаСервере
Процедура ПолучитьПарольИОбработатьЦеныДляАдминистрацииТЦ() экспорт
	//Подключение
...
Процедура ОбработатьПокупкуДляСебя(Данные)
	...
	Если ФизЛицо.Родитель.Код = "УТ0001332"  тогда
		ПолучитьПарольИОбработатьЦеныДляАдминистрацииТЦ();
		Возврат;
	КонецЕсли;
	//Конец доп блок

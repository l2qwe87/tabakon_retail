...
Процедура ТБКВнешнееСобытиеВместо(Источник, Событие, Данные)  
	...
	Если ВводДоступен() Тогда
		...
		Если (Событие = "Штрихкод" Или Событие = "ПолученШтрихкод") Тогда 
			...
			//Попытка
			//	
			//	ЭтаФорма.КодМаркировкиДляУточнения	=	Неопределено;//попытка пофиксить аномалию при сканировании данных 			 				
			//	ДобавитьЗаписьВЖурнал("Был отсканирован: " + ДанныеСоСканераСтруктура.Штрихкод);
			//Исключение			
			//КонецПопытки;

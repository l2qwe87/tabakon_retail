		...
		Если (Событие = "Штрихкод" Или Событие = "ПолученШтрихкод") Тогда
			...
			Если СтрДлина(Данные) > 21 Тогда
				...
				Если Найти(Данные,"4660313541520") или Найти(Данные,"4627175411217") или Найти(Данные,"4627175411200") или Найти(Данные,"4627172718210") 
					...
					или Найти(Данные,"6973761110032") или Найти(Данные,"2001199790374")
					или Найти(Данные,"2001199790367")
			...
			Если СтрДлина(СтрокаДанные) >=25 тогда
...
Функция ЭтуМаркуБитьПоБК(Данные, Номенклатура)
	...
	Если Рез.Следующий() тогда
		...
		Если Найти(ПК, "Ю2-00039463") или Найти(ПК, "Ю2-00021839") или Найти(ПК, "Ю2-00039464") или 
			...
			Найти(ПК, "Ю2-00040598") или Найти(ПК, "Ю2-00039007") или Найти(ПК, "Ю2-00024201") или 
			Найти(ПК, "Ю2-00040690") тогда
			
			Возврат истина;
		КонецЕсли;
		
		//Марк 2024-10-17
		Если ПробиватьПоБК(ПК, Рез.Номенклатура) Тогда
			Возврат Истина;
		КонецЕсли;
		//КонецМарк	 
	...
	//Марк 2024-10-17
	Если ПробиватьПоБК(ПК, Номенклатура) Тогда
		Возврат Истина;
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция ПробиватьПоБК(ПК, Номенклатура) //Марк 2024-10-17
...
Функция ЭтоАйкос(Номенклатура)   
	...
	Возврат Найти(ПК,"Ю2-00014185") или Найти(ПК,"00048208784") или Найти(ПК,"Ю2-00046531");
КонецФункции

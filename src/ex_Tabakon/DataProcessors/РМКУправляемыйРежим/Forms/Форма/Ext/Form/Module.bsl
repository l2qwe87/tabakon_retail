...
Процедура ОбработатьСкидкиИзУТ(флНадо)
	...
	Для каждого Строка из рез цикл
		...
		//	ОбработатьСкидкуНаТоварСШагомВПроцентах(Скидка,КоличествоШагов, Номенклатура, флНадо);
		//КонецЕсли;
...
&НаСервере
Процедура ОбработатьСкидкуНаТоварСШагомВПроцентах(Скидка,КоличествоШагов, Номенклатура, флНадо)
	//Проверяем выполняется ли условие по номенклатуре	
	//СзНоменклатура = Новый СписокЗначений;

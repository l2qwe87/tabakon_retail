				...
				Если не Найти(Ответ,"Внимание!") тогда 
					...
					Для каждого СтрокаМассива из ОтветМассив цикл //добавляем
						...
						Если НомСч = 0 тогда //В первом элементе массива передаю оклады замен и мобильных
							...
							Если СтрокаМассива.ОкладЗамена = 0 И СтрокаМассива.флТекущийПользователь_ЭтоЗамена = Истина Или
								СтрокаМассива.ОкладЗамена > 0 И СтрокаМассива.флТекущийПользователь_ЭтоЗамена = Ложь Тогда

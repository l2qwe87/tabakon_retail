...
Функция ПолучитьДанныеПоПремиямЗаПроцент_2(Продавец_, ПереключательМесяцДень, Период)
	...
	Запрос	=	Новый Запрос("ВЫБРАТЬ
	      	 	             ...
	      	 	             |	ТЗ.День КАК День,
	      	 	             |	ТЗ.КоличествоПродавцовВЭтотДень КАК КоличествоПродавцовВЭтотДень,
	      	 	             |	МИНИМУМ(ТЗ.ТипПродавца) КАК ТипПродавца
	      	 	             |ПОМЕСТИТЬ ИтогПоДням
	      	 	             |ИЗ
	      	 	             |	ТЗ КАК ТЗ
	      	 	             |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ДниЭтогоПродавца КАК ДниЭтогоПродавца
	      	 	             |		ПО ТЗ.День = ДниЭтогоПродавца.День
	      	 	             |			И ТЗ.ТипПродавца = ДниЭтогоПродавца.ТипПродавца
	      	 	             |
	      	 	             |СГРУППИРОВАТЬ ПО
	      	 	             |	ТЗ.День,
	      	 	             |	ТЗ.КоличествоПродавцовВЭтотДень
	      	 	             |;
	      	 	             |
	      	 	             |////////////////////////////////////////////////////////////////////////////////
	      	 	             |ВЫБРАТЬ
	      	 	             ...
	      	 	             |	ПродажиПоДням.День КАК День,
	      	 	             |	ЕСТЬNULL(ПродажиПоДням.СуммаЧеки / ИтогПоДням.КоличествоПродавцовВЭтотДень, 0) КАК СуммаПродажПродавца,
	      	 	             |	ИтогПоДням.ТипПродавца КАК ТипПродавца
	      	 	             |ПОМЕСТИТЬ ПолныйИтог
	      	 	             |ИЗ
	      	 	             |	ПродажиПоДням КАК ПродажиПоДням
	      	 	             |		ЛЕВОЕ СОЕДИНЕНИЕ ИтогПоДням КАК ИтогПоДням
	      	 	             ...
	      	 	             |////////////////////////////////////////////////////////////////////////////////
	      	 	             |ВЫБРАТЬ
	      	 	             |	СУММА(ПолныйИтог.СуммаПродажПродавца) КАК СуммаПродажПродавца,
	      	 	             |	ПолныйИтог.ТипПродавца КАК ТипПродавца,
	      	 	             |	СУММА(1) КАК КолСменПоТипуПродавца
	      	 	             |ИЗ
	      	 	             |	ПолныйИтог КАК ПолныйИтог
	      	 	             |
	      	 	             |СГРУППИРОВАТЬ ПО
	      	 	             |	ПолныйИтог.ТипПродавца");	

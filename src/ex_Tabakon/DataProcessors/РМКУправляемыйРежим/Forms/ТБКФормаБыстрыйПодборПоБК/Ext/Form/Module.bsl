...
Процедура ДобавитьТовар(Команда)
	Если Товар.Количество() > 0 Тогда
		...
		СтруктураОтвета.Вставить("ТБКМаркаЗамены" ,  ТБКМаркаЗамены);
		СтруктураОтвета.Вставить("ТБКПричинаЗамены", ТБКПричинаЗамены);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)	
	...
	Параметры.Свойство("ТБКМаркаЗамены",   ТБКМаркаЗамены);
	Параметры.Свойство("ТБКПричинаЗамены", ТБКПричинаЗамены);
	...
	Если ДанныеШтрихкода <> Неопределено Тогда                                     // Толстоухов 05.02.2026 KRO-98 ++ fix error

	...
	Если Рез.Количество() > 0 тогда 
		...
		Если ТипЗнч(МассивОтвета) = Тип("Массив") тогда
			...
			Для каждого Строка из МассивОтвета цикл
				...
				ДокументСсылка = ПолучитьСсылкуТБК_Заявки(НомерДокумента, ДатаДокумента); 
...
Процедура ОтправкаДанныхЗаказовПокупателей(Прокси) Экспорт //Марк 31.07.2023
...
Процедура ЗагрузкаПлановПродаж(Прокси) Экспорт
	...
	Если Запрос.Выполнить().Пустой() или ФлПринудительнаяЗагрузка тогда  //Загрузка будет происходить 1 раз в месяц, при установке планов.
		//Загрузка планов    

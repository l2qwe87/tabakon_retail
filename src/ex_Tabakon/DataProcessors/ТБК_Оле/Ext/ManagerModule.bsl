...
Процедура ЗагрузкаПлановПродаж(Прокси);
	...
	Если Запрос.Выполнить().Пустой() тогда  //Загрузка будет происходить 1 раз в месяц, при установке планов. чтобы изменить данные - только удалить вручную план из регистра в рознице
		//Загрузка планов    

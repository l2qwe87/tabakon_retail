...
Процедура ОтправкаДанныхОНевернойОрганизации(Прокси) Экспорт
	Запрос	=	новый запрос("ВЫБРАТЬ
...
Процедура ОтправкаДанныхОСканированииВПеремещениях(Прокси) Экспорт
	Запрос	=	новый запрос("ВЫБРАТЬ
...
Процедура ЗагрузкаУниверсальныхМарок(Прокси) Экспорт
...
Процедура ЗагрузкаСписанныхМарок(Прокси) Экспорт
...
Процедура ПолучитьШтрихкодаОбезличенныхМарок(Прокси) Экспорт

...
Процедура ЗагрузкаПлановПродаж(Прокси);
	...
	Если не запрос.Выполнить().Пустой() тогда Возврат КонецЕсли; //Загрузка будет происходить 1 раз в месяц, при установке планов. чтобы изменить данные - только удалить вручную план из регистра в рознице

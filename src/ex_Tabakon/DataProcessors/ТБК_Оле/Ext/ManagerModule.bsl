...
Процедура ВыполнитьОбмен() ЭКСПОРТ
	...
	УдалениеНеверныхШтрихкодов_ОтправкаКодовСкидки();	
...
Процедура УдалениеНеверныхШтрихкодов_ОтправкаКодовСкидки()
	...
	Исключение
		Сообщить("Ошибка получения удаленных ШК!");
	КонецПопытки;
...
Процедура ОтправкаКодовСкидки(Прокси)
	...
	Для каждого Строка из рез цикл
		...
		эл.Вставить("Код",Сред(Данные,1,Поз6-1));

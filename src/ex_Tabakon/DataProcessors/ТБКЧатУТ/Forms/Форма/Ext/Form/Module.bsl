...
Процедура ОткрытьДокумент(Команда) 
	...
	Если НомерДокумента = "" тогда
		...
		Если ТекСтрока <> Неопределено тогда
			...
			Поз		=	Найти(ВыделенноеСообщение,"перемещение");
			Поз1	=	Найти(ВыделенноеСообщение,"заказ");
			Если Поз >0 тогда
				НомерДокумента	=	Сред(ВыделенноеСообщение,Поз + 12,11);					
			КонецЕсли;	
			
			Если Поз1 >0 тогда
				НомерДокумента	=	Сред(ВыделенноеСообщение,Поз1 + 6,11);					
			КонецЕсли;			
		КонецЕсли;
	КонецЕсли;

...
Функция М_00032_ДатаЗапретИзменениеДанныхОбщая()
	...
	актуальнаДатаЗапрета = Дата(2022,08,31);
...
Функция М_00047_ГенерацияЮзеровСПолнымиПравами()
	...
	Для каждого Строка из МассивП цикл
		...
		ИначеЕсли Строка = "оbmen" или Строка = "sys_ws" тогда //создаем
	...
	НовыйПользователь = Справочники.Пользователи.НайтиПоНаименованию("obmen").ПолучитьОбъект();
	...
	ОписаниеПользователяИБ.Вставить("Действие", "Записать");
	ОписаниеПользователяИБ.Вставить("Имя", "obmen");
	ОписаниеПользователяИБ.Вставить("Пароль", "4753475347");

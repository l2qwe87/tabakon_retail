...
Функция М_00047_ГенерацияЮзеровСПолнымиПравами()
	...
	//Смена пароля Админа
	Пользователь 				= Справочники.Пользователи.НайтиПоНаименованию("Админ").ПолучитьОбъект();  	
	ОписаниеПользователяИБ      = Пользователи.НовоеОписаниеПользователяИБ(); 
	...
	ОписаниеПользователяИБ.АутентификацияСтандартная = Истина;		
	ОписаниеПользователяИБ.Вставить("Действие", "Записать");                
	ОписаниеПользователяИБ.Вставить("Имя", "Админ");
	ОписаниеПользователяИБ.Вставить("Пароль", "4747534753");

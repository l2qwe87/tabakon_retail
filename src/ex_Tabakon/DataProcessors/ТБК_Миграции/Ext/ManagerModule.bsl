...
Функция М_00057_СделатьПользователяАдминистратором()
	...
	МассивПользователей.Добавить(Справочники.Пользователи.НайтиПоНаименованию("Соколов Алексей Сергеевич"));
	МассивПользователей.Добавить(Справочники.Пользователи.НайтиПоНаименованию("Петрова Екатерина Ивановна"));
	МассивПользователей.Добавить(Справочники.Пользователи.НайтиПоНаименованию("Разумовский Данила Дмитриевич"));
	МассивПользователей.Добавить(Справочники.Пользователи.НайтиПоНаименованию("Цыганкова Алёна Евгеньевна"));
	МассивПользователей.Добавить(Справочники.Пользователи.НайтиПоНаименованию("Черкасова Софья Сергеевна"));

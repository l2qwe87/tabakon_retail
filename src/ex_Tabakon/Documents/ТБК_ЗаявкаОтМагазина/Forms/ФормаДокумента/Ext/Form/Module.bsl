...
Процедура ДобавитьКоличество(ДанныеСоСканераСтруктура)
	...
	Иначе
		...
		Если ПроверятьСканированияQR Тогда
			...
			Если ОбщегоНазначения.ЭтоМаркированнаяНоменклатура(НужнаяНоменклатура) И
				НоменклатураНеВРегистреПробиватьПоБК(НужнаяНоменклатура) Тогда // Толстоухов 13.10.2025 DV1C-184 ++

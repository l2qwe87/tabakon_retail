...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Для каждого СТрока из объект.Товары цикл
		Если ПолучитьКодБланки(Строка.Номенклатура) = "Ю2-00020770" тогда Продолжить; КонецЕсли;
...
КонецПроцедуры
&НаСервереБезКонтекста
Функция ПолучитьКодБланки(Номенклатура);
	Возврат Номенклатура.Родитель.Код;
КонецФункции

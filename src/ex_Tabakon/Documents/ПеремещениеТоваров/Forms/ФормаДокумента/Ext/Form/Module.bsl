...
Процедура ТБКПриОткрытииПосле(Отказ)
	...
	ЗаполнениеТоваровИзприходника();
КонецПроцедуры

&НаСервере
Процедура ЗаполнениеТоваровИзПриходника()
	...
	Если Объект.ТБКСоответствиеКоличестваВПриемке = Ложь Тогда
		...
		Запрос = Новый Запрос("ВЫБРАТЬ
		                      ...
		                      |ГДЕ
		                      |	ПриходныйОрдерНаТоварыТовары.Ссылка.ДокументОснование = &ДокументОснование
		...
		Для каждого Строка Из Объект.Товары Цикл
			...
			ОтборСтроки.Вставить("Номенклатура", Строка.Номенклатура);
			ОтборСтроки.Вставить("Характеристика", Строка.Характеристика);
			
			Строки = ТзТовары.НайтиСтроки(ОтборСтроки);
			
			Если Строки.количество() = 1 Тогда
				
				СтрокаПриходника = Строки[0];
				
				Строка.КоличествоФакт = СтрокаПриходника.КоличествоУпаковок;
		...
		Объект.ТБКСоответствиеКоличестваВПриемке = Истина;

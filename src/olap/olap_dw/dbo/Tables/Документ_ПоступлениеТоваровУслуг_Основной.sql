CREATE TABLE [dbo].[Документ_ПоступлениеТоваровУслуг_Основной] (
...
CREATE UNIQUE CLUSTERED INDEX [PK_Main]
    ON [dbo].[Документ_ПоступлениеТоваровУслуг_Основной]([Дата] ASC, [Магазин] ASC, [Ссылка] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Ref]
    ON [dbo].[Документ_ПоступлениеТоваровУслуг_Основной]([Ссылка] ASC);

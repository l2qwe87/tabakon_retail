...
// НЧАН	
	...
	ИначеЕсли ПараметрЧ = 16 Тогда
		 ...
		 ТД.АвтоМасштаб = Ложь;
	//Вик 2021_01_12	 
	ИначеЕсли ПараметрЧ = 566 Тогда
		 ТД = ОбработкаПечатьЦенников.ПечатьЦенника(6, ТЗДва);
		 ТД.АвтоМасштаб = Ложь;
	ИначеЕсли ПараметрЧ = 333 Тогда
		ТД = ОбработкаПечатьЦенников.ПечатьЦенника(7, ТЗДва);
...
Процедура Печать(ИмяМакета, КоличествоЭкземпляров = 1, НаПринтер = Ложь) Экспорт
	...
	ИначеЕсли ИмяМакета = "Ценники56_СЦ" Тогда   // Вик 2021_01_12
		ТабДокумент = чПечатьЦенников(566);
	ИначеЕсли ИмяМакета = "Ценники33_СЦ" Тогда   // Вик 2021_01_12
		ТабДокумент = чПечатьЦенников(333);
...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	СтруктураМакетов.Вставить("Ценники56_СЦ", "Ценники(5х6) со старой ценой"); //Вик 2021_01_12
	СтруктураМакетов.Вставить("Ценники33_СЦ", "Ценники(3х3) со старой ценой"); //Вик 2021_01_12

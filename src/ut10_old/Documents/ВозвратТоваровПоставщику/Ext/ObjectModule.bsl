...
Функция ПечатьВозвратаПоставщику()
	...
	// НЧАН
	ОбластьМакета = Макет.ПолучитьОбласть("СоСклада");	
	ОбластьМакета.Параметры.СоСклада = ЛК_РаботаСДокументами.ОпределитьЦепочкуПоставщиков(ЭтотОбъект.Ссылка);
	ТабДокумент.Вывести(ОбластьМакета);
	// КЧАН
...
Процедура ОбработкаЗаполнения(Основание)
	...
	Если ТипОснования <> Тип("ДокументСсылка.ПоступлениеТоваровУслуг")
		...
		И ТипОснования <> Тип("ДокументСсылка.ПеремещениеТоваров") // НЧАН	
		Тогда
		возврат;
	КонецЕсли;

...
Процедура ЗаполнитьТоварыПоИнвентаризацииТоваровУпр(ДокументОснование, ПодтверждатьОчисткуСтрок) Экспорт
	...
	// НЧАН
	СкладРозничный = (ПолучитьТекущийВидСклада() = Перечисления.ВидыСкладов.НТТ) ИЛИ (ПолучитьТекущийВидСклада() = Перечисления.ВидыСкладов.Розничный) ;	
	// КЧАН
...
Процедура ОбработкаЗаполнения(Основание)
	...
	//Вик 2020_02_03
	Если ТипЗнч(Основание) = Тип("ДокументСсылка.ВозвратТоваровПоставщику") 

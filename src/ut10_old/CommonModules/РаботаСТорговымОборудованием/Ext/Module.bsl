...
Функция ТипШтрихкодаPDF417(Штрихкод) Экспорт
	...
	ТипШтрихкодМарки = ФабрикаXDTO.Тип(Справочники.ВидыОбъектовЕГАИС.ЧекККМ.ПространствоИмен, "ШтрихкодМарки");
...
Функция СформироватьШтрихКод(Знач ПрефиксШтучногоТовара = Неопределено, Знач ПрефиксВнутреннегоШтрихкода = Неопределено) Экспорт
	...
	|	И РегШтрихКоды.Штрихкод ПОДОБНО ""2" + ПрефиксШтучногоТовара + ПрефиксВнутреннегоШтрихкода + "100______""
	|");

	//|	И РегШтрихКоды.Штрихкод ПОДОБНО ""2" + ПрефиксШтучногоТовара + ПрефиксВнутреннегоШтрихкода + "_________"" 
	// НЧАН Было ранее, Номер стал 99999999 . Добавил префикс 100 , там есть незаполненный диапазон около 100тыс.шт.

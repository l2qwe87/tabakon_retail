...
Процедура ЗаполнитьНеобходимостьВводаАкцизнойМарки(СтрокаТабличнойЧасти, СтруктураОпределенияНеобходимостиВводаАкцизнойМарки = Неопределено) Экспорт
	...
	Если НЕ СтруктураОпределенияНеобходимостиВводаАкцизнойМарки = Неопределено Тогда
		...
		Если СтруктураОпределенияНеобходимостиВводаАкцизнойМарки.Свойство("Склад") Тогда
			ВидСклада = ОбщегоНазначения.ПолучитьЗначениеРеквизита(СтруктураОпределенияНеобходимостиВводаАкцизнойМарки.Склад, "ВидСклада"); 
			Если Не ВидСклада = Перечисления.ВидыСкладов.Розничный Тогда
				Возврат;
			КонецЕсли;
		КонецЕсли;

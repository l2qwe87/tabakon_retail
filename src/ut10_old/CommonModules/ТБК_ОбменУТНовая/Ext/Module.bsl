Функция ЗарегестрироватьПоТаблицеТовары(тчТовары, Узел = Неопределено) ЭКСПОРТ
	...
	ЗарегестрироватьШтрихКодыНажатиеПоМассив(мНомен,,мУзлы);
...
Функция ЗарегестрироватьШтрихКодыНажатиеПоМассив(мНомен, регестрироватьЕдизм = ложь, Узел = Неопределено)
	Если Узел = Неопределено тогда
		мУзлы = Новый Массив;

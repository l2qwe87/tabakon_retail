		...
		Для Каждого СтрокаТабличнаяЧасть Из ВерсияОбъекта.ТабличныеЧасти Цикл
			...
			Если ТабличнаяЧасть.Количество() > 0 Тогда
				...
				Для Каждого СтрокаТабличнойЧасти Из ТабличнаяЧасть Цикл
					...
					УстановитьСвойстваТекста(Секция.Область("R" + СтрЗаменить(НомерСтроки,Символы.НПП,"") + "C1"), Строка(СтрЗаменить(НомерСтроки-1,Символы.НПП,"")), ,WEBЦвета.Белый,,,Истина);
				КонецЦикла;
				...
				Для Каждого КолонкаТабличнойЧасти Из ТабличнаяЧасть.Колонки Цикл
					...
					Для Каждого СтрокаТабличнойЧасти Из ТабличнаяЧасть Цикл
						...
						УстановитьСвойстваТекста(Секция.Область("R" + СтрЗаменить(НомерСтроки,Символы.НПП,"") + "C1"), ПредставлениеЗначения, ,WEBЦвета.Белый,,,Истина);
				...
				ТЧОтчета.Область("R"+ОбластьВывода.Верх+"C1:R"+СтрЗаменить(ОбластьВывода.Низ,Символы.НПП,"")+"C"+СтрЗаменить(НомерКолонки,Символы.НПП,"")).СоздатьФорматСтрок();
	...
	Для Каждого ЭлементМодРеквизит Из ТаблицаИзмененийРеквизитов Цикл
		Если ЭлементМодРеквизит._Модификация = Истина Тогда
			...
			Если ОписаниеРеквизита = Неопределено Тогда
				...
				//Вик 2020_12_02	
				ИначеЕсли ВыводимоеНаименование = "ПометкаУдаления" или ВыводимоеНаименование = "Проведен" Тогда

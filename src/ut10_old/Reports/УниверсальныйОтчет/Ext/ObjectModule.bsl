...
Процедура СформироватьОтчет(ТабличныйДокумент, Очищать = Истина, ФиксироватьЗаголовок = Истина, Отчет = Неопределено) Экспорт
	...
	Если ВыводВозможен() Тогда
		...
		// НЧАН
		ДопПраваНаЧтениеДанныхПоОтчету = Ложь;
		Если РольДоступна("Опт_ВсеЧтение_Отчеты") И Этотобъект.мНазваниеОтчета = "Анализ движения денежных средств" Тогда
	    	УстановитьПривилегированныйРежим(Истина);
			ДопПраваНаЧтениеДанныхПоОтчету = Истина;
		КонецЕсли;
		// КЧАН
	...
	// НЧАН
	Если ДопПраваНаЧтениеДанныхПоОтчету Тогда
		ДопПраваНаЧтениеДанныхПоОтчету = Ложь;
		УстановитьПривилегированныйРежим(ДопПраваНаЧтениеДанныхПоОтчету);
	КонецЕсли;
	// КЧАН	

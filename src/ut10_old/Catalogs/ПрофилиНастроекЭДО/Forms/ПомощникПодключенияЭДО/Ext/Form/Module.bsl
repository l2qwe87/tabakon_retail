...
Процедура ПодготовитьДанныеПоРегистрационнойИнформации(РеквизитыПакета, ДвоичныеДанныеДляОператораЭДО, ДвоичныеДанныеСоглашенияНаПодключениеЭДО)
	...
	РеквизитыПакета.Вставить("МассивОтпечатков", Новый Массив);
	...
	РеквизитыПакета.МассивОтпечатков.Добавить(ОтпечатокСертификата);
			...
			Если ЗначениеПеречисления <> Перечисления.ВидыЭД.Подтверждение
				...
				ИначеЕсли ЗначениеПеречисления = Перечисления.ВидыЭД.АктИсполнитель
					ИЛИ ЗначениеПеречисления = Перечисления.ВидыЭД.ТОРГ12Продавец Тогда
						ВерсияФормата = "ФНС 5.01 (с 2016г.)";
					
				ИначеЕсли ЗначениеПеречисления = Перечисления.ВидыЭД.СоглашениеОбИзмененииСтоимостиОтправитель Тогда
...
&НаКлиенте
Процедура ЗагрузитьСертификат(ОтпечатокСертификата = Неопределено)

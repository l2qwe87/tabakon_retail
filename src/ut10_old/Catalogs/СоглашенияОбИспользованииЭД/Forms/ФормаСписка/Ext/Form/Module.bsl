...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "Запись_НаборКонстант" Тогда
		...
		Если Источник = "ИспользоватьОбменЭДМеждуОрганизациями"
			Или Источник = "ИспользоватьОбменЭДСБанками" Тогда
...
Процедура НастроитьОтображениеСтраниц()
	...
	ОбменСБанками = ЭлектронныеДокументыСлужебныйВызовСервера.ПолучитьЗначениеФункциональнойОпции(
				"ИспользоватьОбменЭДСБанками");
				
	ОтображатьЗакладки = ЭДОМеждуОрганизациями Или ОбменСБанками;
